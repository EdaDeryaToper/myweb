    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 max-w-7xl">
            ...
            <div className="lg:col-span-2">
                <div className="bg-black/60 border-2 p-5 lg:p-8 backdrop-blur-xl relative"
                    ...
                    <form className="space-y-6 lg:space-y-8">
                        ...
                        <button className="group relative w-full py-4 lg:py-5 text-black font-['Syncopate'] font-bold text-base lg:text-xl uppercase tracking-tighter transition-all active:translate-x-2 active:translate-y-2 active:shadow-none"
                                style={{
                ...
                <span className="relative z-10 flex items-center justify-center gap-3">
                  {t.contact.formLabels.submit}
                    <span className="material-symbols-outlined text-xl lg:text-2xl">send</span>
                </span>
                        </button>
                    </form>
                </div>
            ...
            <div className="space-y-6 lg:space-y-8">
                <div className="bg-black/40 border p-5 lg:p-6 backdrop-blur-md relative overflow-hidden"
                     style={{ borderColor: 'var(--neon-cyan)' }}>
                    
                    <h3 className="font-['Syncopate'] text-sm font-bold mb-5 lg:mb-6 uppercase tracking-widest border-b pb-2"
                        style={{ color: 'var(--neon-cyan)', borderColor: 'var(--neon-cyan)' }}>
                        {t.contact.externalNodes}
                    </h3>
                    <div className="grid grid-cols-1 gap-3 lg:gap-4">
                        <a href="#" className="flex items-center gap-4 p-3 lg:p-4 border transition-all group"
                           style={{ borderColor: 'var(--neon-purple)' }}
                           onMouseEnter={(e) => {
                           ...
                           onMouseLeave={(e) => {
                            ...
                            <span className="material-symbols-outlined text-2xl lg:text-3xl" style={{ color: 'var(--neon-pink)' }}>save</span>
                            <div>
                        ...
                        <a href="#" className="flex items-center gap-4 p-3 lg:p-4 border transition-all group"
                           ...
                           onMouseLeave={(e) => {
                            ...
                            <span className="material-symbols-outlined text-2xl lg:text-3xl" style={{ color: 'var(--neon-cyan)' }}>cable</span>
                            <div>
                        ...
                        <a href="#" className="flex items-center gap-4 p-3 lg:p-4 border transition-all group"
                           ...
                           onMouseLeave={(e) => {
                            ...
                            <span className="material-symbols-outlined text-2xl lg:text-3xl" style={{ color: 'var(--neon-yellow)' }}>podcasts</span>
                            <div>
                ...
                <div className="p-5 lg:p-6 border"
                     style={{
