    ...
    return (
        <div className="space-y-8 lg:space-y-12 max-w-6xl">
            <header className="flex flex-col gap-2 mb-8 lg:mb-12">
                ...
                <div className="h-1 w-32" style={{ background: 'linear-gradient(to right, var(--neon-cyan), transparent)' }} />
            </header>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-8">
                {SKILLS.map(skill => (
                    <div key={skill.name} className="bg-black/40 border border-[var(--neon-cyan)]/20 p-5 lg:p-6 backdrop-blur-lg relative overflow-hidden group hover:border-[var(--neon-cyan)]/40 transition-all">
            ...
            <div className="mt-12 lg:mt-16 flex flex-col items-center gap-8">
                <div className="flex gap-4">
                    <div className="w-16 lg:w-20 h-1" style={{ backgroundColor: 'var(--neon-pink)', boxShadow: '0 0 8px var(--neon-pink)' }} />
                    <div className="w-16 lg:w-20 h-1" style={{ backgroundColor: 'var(--neon-cyan)', boxShadow: '0 0 8px var(--neon-cyan)' }} />
                    <div className="w-16 lg:w-20 h-1" style={{ backgroundColor: 'var(--neon-yellow)', boxShadow: '0 0 8px var(--neon-yellow)' }} />
                </div>
