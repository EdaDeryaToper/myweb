      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 items-center min-h-[70vh]">
          ...
          <div className="max-w-xl space-y-5">
            ...
            <div className="p-5 bg-white/5 border-l-4 border-[#ff71ce] backdrop-blur-md">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-[10px] font-bold tracking-[0.2em] text-[#fffb96] uppercase">{t.home.identityTitle}</span>
              </div>
        ...
        <div className="order-1 lg:order-2 lg:col-span-2 flex justify-center lg:justify-end">
          <div className="relative w-full max-w-[280px] sm:max-w-sm lg:max-w-lg aspect-square">
            <div className="absolute inset-0 border border-[#01cdfe] rounded-full opacity-20 animate-[pulse_3s_infinite]" />
            <div className="absolute inset-10 border border-[#ff71ce] rounded-full opacity-10 animate-[reversePulse_4s_infinite]" />
            <div className="absolute inset-20 border border-[#b967ff] rounded-full opacity-5" />
            <style>{`
          ...
          `}</style>
            <div className="relative z-10 w-full h-full flex items-center justify-center">
              <div className="absolute inset-1/4 bg-gradient-to-tr from-[#b967ff] via-[#ff71ce] to-transparent opacity-30 blur-3xl animate-pulse" />
              <div className="w-4/5 h-4/5 flex items-center justify-center">
                <div className="relative w-28 h-28 sm:w-40 sm:h-40 lg:w-48 lg:h-48">
                  <div className="absolute inset-0 border-2 border-[var(--neon-cyan)] transform rotate-45 opacity-60" />
                  <div className="absolute inset-4 border-2 border-[var(--neon-pink)] transform -rotate-12 opacity-40" />
                  <div className="absolute inset-8 border-2 border-[var(--neon-purple)] transform rotate-12 opacity-30" />
                  <div className="absolute inset-12 bg-[var(--neon-cyan)] opacity-10 blur-xl" />
                </div>
              </div>
            </div>
