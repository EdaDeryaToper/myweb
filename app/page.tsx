...
export default function Home() {
  ...
  if (!isBooted) {
    return (
        <div className="fixed inset-0 bg-[#120422] flex flex-col items-center justify-center font-mono text-[#01cdfe]">
          <div className="mb-4 text-sm sm:text-xl tracking-[0.3em] sm:tracking-[0.5em] text-center px-4 animate-pulse">
            {t.system.booting}
          </div>
          <div className="w-48 sm:w-64 h-1 bg-white/10 relative overflow-hidden">
            <div
                className="absolute inset-y-0 left-0 bg-[#ff71ce] animate-[loading_1.5s_ease-in-out_infinite]"
                style={{ width: '40%' }}
            />
          </div>
          <style>{`
  ...
  return (
      <div className="relative min-h-screen flex overflow-hidden">
        {/* Background */}
        <div className="fixed inset-0 grid-background z-0 opacity-40" />
